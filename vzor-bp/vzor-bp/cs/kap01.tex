...
\begin{figure}[h]
	\centering
	\subfloat[Dijkstrův algoritmus.]{\includegraphics[width=0.47\textwidth]{dijkstra-trap}\label{fig:dijkstra}}
	\hfill
	\subfloat[A* algoritmus.]{\includegraphics[width=0.47\textwidth]{a-star-trap}\label{fig:astar}}
