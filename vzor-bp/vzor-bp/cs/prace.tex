...
\definecolor{blueattributes}{rgb}{0.2,0.2,1}
...
\def\TypPracoviste{Katedra distribuovaných a spolehlivých systémů}
\def\TypPracovisteEN{Department of Distributed and Dependable Systems}
